...
mongoose.connect("mongodb+srv://Shadow:Shadow098@cluster0.triozcm.mongodb.net/Test?retryWrites=true&w=majority",
  {
...
app.post('/find',(req,res)=>{
  ...
  Phrases.findOne({value:req.body.w.toString()},(err,data)=>{
    if (err) {
      console.log(err)
    }
    if (data) {
